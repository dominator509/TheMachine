# SPEC-005-auth-and-permissions: Auth and Permissions
...
Phase 5: Auth, permissions, security
...
The Machine protects local secrets, repositories, commands, MCP tools, and plugins while staying simple for single-user local operation.
