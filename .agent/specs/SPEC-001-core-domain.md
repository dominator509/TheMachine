# SPEC-001-core-domain: Core Domain
...
The Machine reliably guides coding agents through scoped, restartable implementation plans without drift, freeze, or fixation.
