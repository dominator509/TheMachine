# SPEC-000-product-scope: Product Scope
...
A user can use The Machine to turn a repository and blueprint pack into a fully shippable repository through structured autonomous coding-agent passes.
