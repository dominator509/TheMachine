# SPEC-006-error-handling: Error Handling
...
EP-002, EP-003, EP-004, EP-005, EP-006, EP-007

## User-Visible Goal

Errors are clear, typed, recoverable when possible, and never cause agents to drift, freeze, or fixate.
