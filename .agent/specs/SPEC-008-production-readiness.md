# SPEC-008-production-readiness: Production Readiness
...
A release of The Machine can be shipped with evidence that it works, is tested, secure, observable, installable, rollbackable, and supportable.
