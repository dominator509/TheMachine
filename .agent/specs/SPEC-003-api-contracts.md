# SPEC-003-api-contracts: API, Service, CLI, and SDK Contracts
...
A user or coding agent can operate The Machine through stable CLI and local service contracts without guessing commands or routes.
